    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('M', 'M'), ('F', 'F')], max_length=20, null=True)),
                ('year', models.IntegerField(verbose_name='production_year')),
                ('hour_rate', models.FloatField(verbose_name='hour_rate')),
                ('pickup_date', models.DateTimeField(auto_now=True, verbose_name='pick_up_time')),
                ('return_date', models.DateTimeField(auto_now=True, verbose_name='return_time')),
                ('total_price', models.FloatField(verbose_name='total_price')),
                ('add_on_accessory', models.CharField(max_length=255, verbose_name='accessory')),
